...
class ReminderDiseaseScreen extends StatefulWidget {
  const ReminderDiseaseScreen({super.key});

  @override
  State<ReminderDiseaseScreen> createState() => _ReminderDiseaseScreenState();
}

class _ReminderDiseaseScreenState extends State<ReminderDiseaseScreen> with SingleTickerProviderStateMixin {
  late TabController _tabController;
  bool isTherapeutic = true;
  String activeFilter = 'الترميمات';
      ...
      child: Row(
        children: [
          ...
          GestureDetector(
            ...
            child: _buildDetailTab('قياسات', false),
          ),
          const SizedBox(width: 12),
          _buildDetailTab('تذكير', true),
          const SizedBox(width: 12),
        ...
        children: [
          Align(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFFC2FAEF).withOpacity(0.4),
                borderRadius: BorderRadius.circular(42),
              ),
              child: const Text(
                'نوع التذكير: متابعة',
                style: TextStyle(color: Color(0xFF106970), fontSize: 11, fontWeight: FontWeight.bold),
              ),
            ),
          ),
          const SizedBox(height: 12),
          ...
          const SizedBox(height: 8),
          const Text(
            'الاتصال بالمريض للتأكد من اختفاء الألم بعد الحشو.',
            style: TextStyle(color: Color(0xFF8A8AA3), fontSize: 13, height: 1.5),
          ),
